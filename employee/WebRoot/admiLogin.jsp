...
<head>
    ...
    <style type="text/css">
        ...
        .login-type-icon {
            ...
            width: 47px;
            height: 47px;
            background-image: url(https://yun-campus-res.oss-cn-shenzhen.aliyuncs.com/public/images/icon/qr_ico.png);
            position: absolute;
            top: 5px;
            right: 5px;
        }
...
<div class="log-jumbotron container">
    ...
    <div class="manage-header">
        <div class="container-fixed" style="max-width:1200px;">
                        <img src="http://yun-campus-res.oss-cn-shenzhen.aliyuncs.com/school/1495449423-3394.png" height="50px">
                    </div>
    </div>
        ...
        <div class="clearfix">
            ...
            <div class="j-pc">
                ...
                <div class="login" style="float:left;width:100%;">
                    ...
                    <button type="submit" id="login_btn" class="btn btn-success login-btn">
            ...
            <div class="qrcode-login j-qr" style="display: none">
                <div class="qrcode-mod">
                    <div class="qrcode-main">
                        <div class="qrcode-img" style="opacity: 1;"><img class="j-qr-img" style="display: block;">
                        </div>
                    </div>
            ...
            init: function () {
                ...
                $('.login-type-icon').click(function () {
                    ...
                    if (bg_url.indexOf('pc_') > 0) {
                        $(this).css('background-image', 'url(https://yun-campus-res.oss-cn-shenzhen.aliyuncs.com/public/images/icon/qr_ico.png)');
                        ...
                        $('.j-pc').hide();
                        $('.j-qr').show();
                        $(this).css('background-image', 'url(https://yun-campus-res.oss-cn-shenzhen.aliyuncs.com/public/images/icon/pc_ico.png)');
