...
<body class="loginpage" style="overflow: hidden">
    <div class="manage-header">
        <div class="container-fixed">
                        ...
                        <span class="pull-right qq-help" style="margin: 10px 0 0 0">
                <!--<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=879656665&site=qq&menu=yes">
                    <table>
                        <tr>
                            <td><img border="0" src="http://wpa.qq.com/pa?p=2:879656665:52" alt="点击这里咨询帮助"
                                    title="点击这里咨询帮助"/></td>
                ...
                <!--<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2583053649&site=qq&menu=yes">
                    <img border="0" src="http://wpa.qq.com/pa?p=2:2583053649:52" alt="点击这里帮助咨询" title="点击这里帮助咨询"/>
                </a>-->
            </span>
        </div>
    </div>
            ...
            <div class="log-panel form-signin">
                <div class="login-form">
                    <p class="f18 mb18">分团委登录<span style="color: orangered"></span></p>
                        ...
                        <input type="text" placeholder="学工号" id="user_name" name="LoginForm[userName]" value="" required >
                    </div>
                    <div class="text-wrap" id="div_password">
                        <span class="icon icon-pass"></span>
                        <input data="1433" type="password" placeholder="密码" id="password">
                    ...
                    <div class="login">
                        ...
                        <button type="button" id="login_btn" class="btn-pr ok-btn f14 login-btn" data-id="1433">登录</button>
                    </div>
